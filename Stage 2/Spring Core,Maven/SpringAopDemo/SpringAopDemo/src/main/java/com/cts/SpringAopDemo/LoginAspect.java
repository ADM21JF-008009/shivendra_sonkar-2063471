...
public class LoginAspect {
	...
	// Type your code here
	@Before(value = "execution(* com.cts.SpringAopDemo.EasyBank.showBalance(..))")
	...
	// Type your code here
	@AfterReturning(value="execution(* com.cts.SpringAopDemo.EasyBank.doChangePin(..))")
	public void afterPinChange() {
		System.out.println("You have successfully changed your pin");
	}

	// Type your code here
	@AfterThrowing(value="execution(* com.cts.SpringAopDemo.EasyBank.*(..))")
